				...
				<form id="login-form" action="ServletCrearCapacitacion"
					...
					<div class="mb-3">
						...
						<input id="identificador" placeholder="Numérico"
							class="form-control" name="identificador"> <small
							id="identificadorHelp" class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="duracion" class="form-label">Duracion de la
							capacitación</label> <input class="form-control" placeholder="Numérico"
							id="duracion" name="duracion"> <small id="duracionHelp"
							class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="cantidadAsistentes" class="form-label">Cantidad
							Asistentes de la Capacitación</label> <input type="text"
							placeholder="Numérico" class="form-control"
							id="cantidadAsistentes" name="cantidadAsistentes"> <small
							id="cantidadAsistenteHelp" class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="rut_cliente" class="form-label">Rut Cliente</label> <input
							type="text"
							placeholder="Numérico sin puntos, guión ni dv, <99999999"
							class="form-control" id="rutCliente" name="rutCliente"> <small
							id="rutClienteHelp" class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="tematica" class="form-label">Tematica de la
							capacitación </label> <input type="text" class="form-control"
							id="tematica" name="tematica"> <small id="tematicaHelp"
							class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="lugar" class="form-label">Lugar de la
							capacitación</label> <input type="text" class="form-control" id="lugar"
							name="lugar"> <small id="lugarHelp"
							class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="Dia" class="form-label">Dia de la Capacitación</label>
						<input type="date" placeholder="Lunes, Martes..."
							class="form-control" id="dia" name="dia"> <small
							id="diaHelp" class="form-text text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="hora" class="form-label">Horario de la
							capacitación</label> <input type="time" placeholder="HH:MM"
							class="form-control" id="hora" name="hora"> <small
